export const metadata = {
  ...
  date: '2024-09-25',
  tags: ['software', 'workflow', 'arc', 'firefox', 'hyper', 'warp', 'wezterm', 'spotify', 'apple music', 'qobuz'],
};

import Hero from "@/app/components/Hero"

<Hero heading={metadata.title} subHeading={metadata.date} />

<div className="max-w-screen-md mx-auto px-4 my-12 markdown-format">
